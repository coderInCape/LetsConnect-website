	...
	<div class="mainContent" id="mainContent">
		<div class="content"> 
			<div class="content1">
				...
				<!-- Mark: Here you have to show the values from the post add and show it to the user -->
				...
				<div class="functionContent">
					...
					<div class="form-group">
						<div class="success">
							<h2>Your Donation Item Post has been successfully added</h2>
							<p>Your post is: <?php echo ($_SESSION['itemname'])?></p>
							<p>Photo:</p>
							<img src="<?php echo htmlspecialchars($_SESSION['uploaditemimage']); ?>"></img>
							<p>Price: $<?php echo ($_SESSION['price'])?></p>
							<a class="button" href="clientPanlDonationPost.php">Add Another Donation Item Post</a>
						</div>
					</div>
				</div>
