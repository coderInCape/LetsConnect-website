...
$x = $_GET['x'];
	...
	$query = "select *
            FROM REQUEST
            WHERE requestid = '$x'";
	$query2 = "select U.* from USER U,REQUEST I WHERE I.username = U.username and I.requestid = '$x'";
  ...
  $result4 = mysql_query( $query4 );
   ...
   $query6 = "select AVG(rating) from FEEDBACK where username='$username2'";
...
?>
	...
	<div class="mainContent" id="mainContent">
		<div class="content">
			<div class="topContent">
				...
				<figure class="itemImage"><a href="#"><img src="<?php echo htmlspecialchars($userimage2); ?>"/> </a></figure>
				<div class="contentInfo">
					<header>
						<h1><a href="#" ><?php echo $description?></a><h1>
					</header>
					<footer>
	...
	<?php }
		...
		<div class="requestitembtns" id="requestitembtns">
					<a href='login.php' class='button'>Login To send message to user</a>
				</div>
